...
//   const [editingSubcategoryId, setEditingSubcategoryId] = useState(null);
//   const [isEditing, setIsEditing] = useState(false);
//   const [mainCheckbox, setMainCheckbox] = useState(false); // Main checkbox state
//   const [selectedBlockedIds, setSelectedBlockedIds] = useState([]); // Selected sub-checkboxes
...
//     if (newCheckedState) {
//       // Select all blocked subcategories
//       setSelectedBlockedIds(blockedSubcategories.map((sub) => sub.id));
//     } else {
//       // Deselect all
...
//   // Handle individual sub-checkbox change
//   const handleSubCheckboxChange = (subId) => {
//     const isSelected = selectedBlockedIds.includes(subId);
//     let newSelectedIds;

//     if (isSelected) {
//       // Remove the subId and uncheck main checkbox
//       newSelectedIds = selectedBlockedIds.filter((id) => id !== subId);
//       setMainCheckbox(false);
//     } else {
//       // Add the subId and check if all are selected
//       newSelectedIds = [...selectedBlockedIds, subId];
//       if (newSelectedIds.length === blockedSubcategories.length) {
//         setMainCheckbox(true);
//       }
//     }

//     setSelectedBlockedIds(newSelectedIds);
//   };
...
//               )
//             );
//             // Update blocked list selection if enabling/disabling affects it
//             if (newStatus) {
...
//   const toggleOptionsVisibility = useCallback(() => {
//     setIsVisible((prev) => !prev);
//     setMainCheckbox(false); // Reset main checkbox when opening/closing
//     setSelectedBlockedIds([]); // Reset selected sub-checkboxes
//   }, []);
...
//                               <input
//                                 type="checkbox"
//                                 checked={selectedBlockedIds.includes(sub.id)}
//                                 onChange={() => handleSubCheckboxChange(sub.id)}
//                               />
//                             </label>
//                             <span className="text-[#999999] font-normal text-base px-2.5">
//                               {highlightText(

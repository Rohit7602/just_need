    ...
    <div>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 xl:gap-5">
        ...
        <div className="flex items-center gap-2 xl:gap-4">
          ...
          >
            <div  onClick={toggleSearchInput} className={`cursor-pointer w-[40px] flex items-center justify-center`}>
              <SearchIcon />
            </div>
            {isInputVisible && (
              <input
            ...
            {isInputVisible && (<div onClick={toggleSearchInput} className="px-3"><BlackCloseIcon/></div>)}
          </div>
          <Link
            to={"/dashboard/chat"}

  ...
  return (
    <div className="relative z-[100]">
      <div className="bg-white border-2 border-[#00000026] w-[400px] mt-4 rounded-[10px] ">
        ...
        <div>
          <h2
            className="font-normal sm:text-sm md:text-base text-black py-4 px-5 rounded-[10px] hover:bg-[#eee] cursor-pointer"
          ...
          {activeDropdown === 'duration' && (
            <div className="px-5 pb-3">
              <div>
                <input type="radio" id="today" name="duration" className="mr-2" />
              ...
              <div className='mt-2.5'>
                <input type="radio" id="oneMonth" name="duration" className="mr-2" />
                <label className='text-base font-normal' htmlFor="oneMonth">1 Month</label>
              </div>
              <div className='mt-2.5'>
                <input type="radio" id="twoMonths" name="duration" className="mr-2" />
        ...
        <div>
          ...
          {activeDropdown === 'serviceType' && (
            <div className="px-5 pb-3">
              ...
              <div className='mt-2.5'>
                <input type="radio" id="painter" name="serviceType" className="mr-2" />
                <label className='text-base font-normal' htmlFor="painter">Painter</label>
              </div>
              <div className='mt-2.5'>
                <input type="radio" id="carpenter" name="serviceType" className="mr-2" />
                <label className='text-base font-normal' htmlFor="carpenter">Carpenter</label>
              </div>
              <div className='mt-2.5'>
                <input type="radio" id="plumber" name="serviceType" className="mr-2" />
        ...
        <div>
          ...
          {activeDropdown === 'complaintStatus' && (
            <div className="px-5 pb-3">
              ...
              <div className='mt-2.5'>
                <input type="radio" id="pending" name="complaintStatus" className="mr-2" />

...
function DisableProviderPopUp({ handlePopupDisable }) {
  ...
  const handleUpdate = () => {
    ...
    setSubmittedData(popUpData); // Store the submitted data
  };
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 relative">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full h-28 px-3 py-2 bg-gray-100 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none border-none"
            ></textarea>
          </div>

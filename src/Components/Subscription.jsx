    ...
    <div className="w-full min-h-screen p-[15px] bg-white rounded-[10px]">
      ...
      <div className="flex -mx-3 flex-wrap">
        <div className=" w-6/12 xl:w-4/12 2xl:w-3/12 px-3">
          <div className=" bg-gradient-to-r from-[#8970F2] to-[#321A95] p-5 rounded-[10px] group cursor-pointer">
        ...
        <div className="w-6/12 xl:w-4/12 2xl:w-3/12 px-3">
          <div className="bg-gradient-to-r from-[#B870F2] to-[#3A1479] p-5 rounded-[10px] group cursor-pointer">
            <div className="flex items-center justify-between">
              <h1 className="text-xl xl:text-[26px] font-semibold text-white">
                PREMIUM
              </h1>

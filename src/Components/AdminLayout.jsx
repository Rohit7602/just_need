  ...
  return (
    <div className="flex bg-white px-4 pt-4 gap-4">
      ...
      <div className="w-[calc(100vw-200px)] xl:w-[calc(100vw-270px)] pb-5  h-screen overflow-scroll scrollRemove ">
        <div className="sticky top-0 z-50 bg-[#F4F4F4] px-4 pt-5 pb-[15px] rounded-[10px]">
          <TopBar />
        </div>
        <div className=" pt-4 min-h-[calc(100vh-85px)] flex flex-col bg-[#F7F7F7] mt-4 rounded-[10px]">
          <Outlet />
        </div>
      </div>
    </div>

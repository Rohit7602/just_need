            ...
            <div className="flex justify-between mt-6">
              <div>
                <div className="flex justify-between">
                  <div className="flex">
                    <div>
                      <img className="flex h-[52px] w-[52px] rounded-full" src={listData?.thumbnailImage} alt="" />
                    </div>

                    <div className="ms-3">
                      <div className="flex items-center gap-[10px]">
                        <p className="font-semibold text-lg ">{listData?.user_detail?.firstName} {listData?.user_detail?.lastName}</p>
                      </div>
                      <p className="font-normal text-sm text-[#ADA4A5]">{listData?.title}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex mt-[16px]">
                  ...
                  <span className="text-[#1D1617] font-normal text-sm opacity-[50%] ms-10"> +91-{listData?.user_detail?.mobile_number}</span>
                </div>
                <div className="flex mt-[16px]">
                  <span className="font-normal w-[100px] text-sm flex justify-between">Category <span className="ms-5">:</span></span>
                  <span className="bg-[#6C4DEF1A] font-normal text-sm rounded-[90px] text-purple-700 px-2 py-0.5  border-none outline-none ms-10">Vehicle</span>
                </div>
                <div className="flex mt-[16px]">
                  <span className="font-normal w-[100px] text-sm flex justify-between">Email <span className="ms-5">:</span></span>
                  <span className="text-[#1D1617] font-normal text-sm opacity-[50%] ms-10">johndeo12@gmail.com</span>
                </div>
                <div className="flex mt-[16px]">
                  <span className="font-normal w-[100px] text-sm flex justify-between">Address <span className="ms-5">:</span></span>
                  <span className="text-[#1D1617] font-normal text-sm opacity-[50%] ms-10">Hisar Haryana B street 352</span>
                </div>
                ...
                >
                  {listData?.blockStatus?.isBlocked ? (
                    <button className="px-[37px] py-[12px] text-[#FF0000] border-[#FF0000] border font-medium text-base rounded-[10px] mt-[19px] flex items-center">
                      <span className="me-2"><DisableIcon /></span>
                      Block
                    </button>
                  ) : (
                    <button className="px-[37px] py-[12px] text-[green] border-[green] border font-medium text-base rounded-[10px] mt-[19px] flex items-center">
                      <span className="me-2"><EnableIcon /></span>
                      Active
                    </button>
                  )}
                </button>
            ...
            <div className="flex gap-3 flex-wrap">
              {listData?.images?.length > 0 &&
                listData?.images?.map((item, index) => (
                  <div key={index} className="relative rounded-md w-[200px] overflow-hidden group mt-5">
                    <img
